...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ['id', 'project_name', 'labour_ids', 'material_id', 'material_quantity', 'equipment_id', 'equipment_quantity']
 
class LabourSerializer(serializers.ModelSerializer):
    class Meta:
        model = Labour
        fields = ['id', 'labour_name','profession','profession_name','allocated']
 
class EquipmentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Equipment
        fields = ['id', 'equipment_name', 'quantity']
 
class MaterialSerializer(serializers.ModelSerializer):
    class Meta:
        model = Material
        fields = ['id', 'material_name', 'quantity','units']
